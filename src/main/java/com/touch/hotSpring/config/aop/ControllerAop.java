package com.touch.hotSpring.config.aop;

import com.touch.hotSpring.util.GetIPUtil;
...
public class ControllerAop {
    ...
    //匹配com.touch.plantlet.controller包及其子包下的所有类的所有方法
    @Pointcut("execution(* com.touch.hotSpring.controller.*..*(..))")
